...
book_name = "The Essence of Shinto: Japan's Spiritual Heart"
...
print(f"{author} wrote the book {book_name} in the year {publication_year}" + "." + f" It is now sold for {book_price} in most stores.")
